#!/bin/bash
# Full gapseq pipeline for E. coli K-12 MG1655.
# Steps: find -> find-transport -> draft -> fill
# Output goes to data/gapseq/ecoli/
set -e
...
WORK="$HERE/data/gapseq/ecoli"
GENOME="$HERE/data/genomes/ecoli_k12_mg1655.fasta"
PREFIX=ecoli
...
echo "Started: $(date)"
echo "============================================================"
# Use the standard ALL medium for gap-filling — most permissive, lets
# the algorithm pick the minimal set of reactions to enable growth
